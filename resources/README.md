<picture>
  <source media="(prefers-color-scheme: dark)" srcset="logos/copilot-howto-logo-dark.svg">
  <img alt="Copilot How To" src="logos/copilot-howto-logo.svg">
</picture>

# Copilot How To - Brand Assets

Complete collection of logos, icons, and favicons for the Copilot How To project. All assets use the V3.0 design: a compass with code bracket (`>`) symbol, representing guided navigation through code — using a Black/White/Gray palette with Bright Green (#22C55E) accent.
...
resources/
├── logos/
│   ├── copilot-howto-logo.svg       # Main logo - Light mode (520×120px)
│   └── copilot-howto-logo-dark.svg  # Main logo - Dark mode (520×120px)
├── icons/
│   ├── copilot-howto-icon.svg       # App icon - Light mode (256×256px)
│   └── copilot-howto-icon-dark.svg  # App icon - Dark mode (256×256px)
└── favicons/
...
**Files**:
- `logos/copilot-howto-logo.svg` (Light mode)
- `logos/copilot-howto-logo-dark.svg` (Dark mode)
...
**Files**:
- `icons/copilot-howto-icon.svg` (Light mode)
- `icons/copilot-howto-icon-dark.svg` (Dark mode)
...
These assets are part of the Copilot How To project.
