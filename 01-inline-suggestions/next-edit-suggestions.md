...
As of early 2026, NES is only available in VS Code. JetBrains, Neovim, and Xcode support standard inline ghost text but not NES. Check the [feature matrix](../02-ide-integration/feature-matrix.md) for the latest status.
