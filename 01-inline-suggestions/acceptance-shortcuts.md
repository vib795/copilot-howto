...
Xcode's Copilot integration is limited to inline suggestions (ghost text). There are no shortcut keys for cycling between alternative suggestions or partial acceptance. See [../02-ide-integration/xcode-setup.md](../02-ide-integration/xcode-setup.md) for full setup details.
