...
The security of the Copilot How To project is important to us. This document outlines our security practices and describes how to report security vulnerabilities responsibly.
...
- Vulnerabilities in GitHub Copilot itself (report to GitHub Security)
...
Past security advisories are available in the [GitHub Security Advisories](https://github.com/luongnv89/copilot-howto/security/advisories) tab.
...
Thank you for helping keep Copilot How To secure! 🔒
