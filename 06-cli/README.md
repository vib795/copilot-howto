...
If you previously used `claude -p` as part of a CI/CD pipeline or automation script, the closest Copilot equivalent is the **Copilot coding agent in GitHub Actions** (not `gh copilot suggest`). See [../12-github-actions/copilot-in-actions.md](../12-github-actions/copilot-in-actions.md).
