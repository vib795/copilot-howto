...
# ///
"""
Build an EPUB from the Copilot How-To markdown files.
...
Usage:
    ...
    Command-line options:
        ...
        --output, -o    Output EPUB file path (default: <root>/copilot-howto-guide.epub)
...
Requirements:
    ...
    - Repository structure with markdown files and copilot-howto-logo.png
"""
...
class EPUBConfig:
    ...
    # EPUB Metadata
    identifier: str = "copilot-howto-guide"
    title: str = "GitHub Copilot How-To Guide"
    language: str = "en"
    author: str = "Copilot How To Community"
...
def validate_inputs(config: EPUBConfig, logger: logging.Logger) -> None:
    ...
    logo_path = config.logo_path or (config.root_path / "copilot-howto-logo.png")
...
def get_chapter_order() -> list[tuple[str, str]]:
    ...
    return [
        ...
        ("copilot_concepts_guide.md", "Copilot Concepts Guide"),
        ("01-slash-commands", "Slash Commands"),
        ("02-custom-instructions", "Custom Instructions"),
        ("03-extensions", "Extensions"),
        ("04-chat-variables", "Chat Variables"),
        ("05-github-actions", "GitHub Actions"),
        ("06-copilot-workspace", "Copilot Workspace"),
        ("07-cli", "CLI"),
        ("08-inline-suggestions", "Inline Suggestions"),
        ("09-ide-integration", "IDE Integration"),
...
def create_cover_image(
    ...
    title: str = "GitHub Copilot\nHow-To Guide",
    subtitle: str = "Complete Guide to GitHub Copilot Features",
) -> bytes:
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Build an EPUB from the Copilot How-To markdown files."
    )
    parser.add_argument(
        "--root",
        "-r",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output EPUB file path (default: <root>/copilot-howto-guide.epub)",
    )
    parser.add_argument(
    ...
    root = root.resolve()
    output = args.output or (root / "copilot-howto-guide.epub")
