...
- Internet access to `api.githubcopilot.com` (see [../15-enterprise/network-proxy.md](../15-enterprise/network-proxy.md) for corporate network configuration)
...
For the full cross-IDE shortcut reference, see [../01-inline-suggestions/acceptance-shortcuts.md](../01-inline-suggestions/acceptance-shortcuts.md).
...
If you are behind a corporate proxy or firewall, see [../15-enterprise/network-proxy.md](../15-enterprise/network-proxy.md) for configuration instructions.
...
Refer to [../15-enterprise/network-proxy.md](../15-enterprise/network-proxy.md) for firewall configuration.
...
- See [../01-inline-suggestions/effective-prompting-for-completion.md](../01-inline-suggestions/effective-prompting-for-completion.md) for prompting strategies
