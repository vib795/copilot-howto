...
4. **Check internet connectivity**: Copilot requires access to `api.githubcopilot.com`. If on a corporate network, ensure this host is allowlisted. See [../15-enterprise/network-proxy.md](../15-enterprise/network-proxy.md).
