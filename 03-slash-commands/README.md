...
2. **Use custom instructions** — Write persistent instructions in `.github/copilot-instructions.md` or VS Code settings to shape how existing commands respond. Does not add new commands, but changes behavior. See the [custom instructions guide](../05-custom-instructions/README.md).
